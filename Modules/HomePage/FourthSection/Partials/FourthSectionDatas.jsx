import fourthsecimgone from "../../../../assets/Images/effortless.webp";
import fouthsecimgtwo from "../../../../assets/Images/customizedinterface.webp";
import fourthsecimgthree from "../../../../assets/Images/powerupprotection.webp";
import fourthsecimgfour from "../../../../assets/Images/secureapp.webp";
import fourthsecimgfive from "../../../../assets/Images/easytouse.webp";

export const fourthSecDatas = [
  {
    key: 1,
    paraHead: "Effortless kiosk deployment & management",
    content:
    ...
    paraSub: "TRY FOR FREE",
    img: fourthsecimgone,
  },
  {
    key: 2,
    paraHead: "Customized interface for brand visibility",
    content:
  ...
  {
    key: 3,
    paraHead: "What more can you do with Hexnode kiosk?",
    content:
    ...
    paraSub: "TRY FOR FREE",
    img: fourthsecimgthree,
  },
  {
    key: 4,
    paraHead: "Secure and update your app ecosystem",
    content:
    ...
    paraSub: "TRY FOR FREE",
    img: fourthsecimgfour,
  },
  {
    key: 5,
    paraHead: "Provide an easy-to-use interface for end-users",
    content:
